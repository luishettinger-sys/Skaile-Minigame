...
export const WEAPONS = {
  ...
  shotgun: {
    ...
    projScale: 0.9, speed: 46, color: 0xff8c1a, sound: "shotgun", energyCost: 24,
  ...
  railgun: {
    ...
    projScale: 1.1, speed: 98, color: 0xff6ec7, sound: "rail", energyCost: 30,
  ...
  cannon: {
    ...
    projScale: 1.9, speed: 40, color: 0x80ed99, sound: "cannon", energyCost: 34,
